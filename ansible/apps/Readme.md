## Apply local-path storage class
```
...
```
Test sotrage class to create pvc and volume pod
```
...
Patch k8s storage class to use local-path as default
```
kubectl get sc
